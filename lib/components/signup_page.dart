                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(color: const Color(0xffEEF1F3), width: 3),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: const Text('Log-in', style: TextStyle(fontSize: 15, color: Color(0xff939393), fontWeight: FontWeight.bold),),
                            ),
                          ],
                        ),
                      ),
